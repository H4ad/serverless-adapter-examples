...
exports.frameworkOptions = exports.appRouter = void 0;
...
exports.appRouter = trpc
    .router()
    .transformer(new trpc_1.BufferToJSObjectTransformer())
    .query('getUser', {
    ...
    resolve: function (req) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, { id: req.input, name: 'Bilbo' }];
            });
        });
    }
})
...
exports.frameworkOptions = {
    createContext: function () { return ({ currentDate: new Date() }); }
};
